...
#Configure our NFS Export in /etc/exports for /export/volumes. Using no_root_squash and no_subtree_check to 
...
kubectl get pods
kubectl delete p    ods nginx-nfs-deployment-[tab][tab]
